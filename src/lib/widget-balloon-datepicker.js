...
(function($) {
  ...
  var BalloonDatePicker = DatePicker.extend({
    ...
    init: function(target, options) {
      ...
      $kSelect.empty();
      $kSelect.append('<svg class="gr-icon gr-i-calendar" viewBox="0 0 24 24"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/assets/icons.svg#calendar"></use></svg>');
    },
