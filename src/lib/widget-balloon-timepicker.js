...
(function($) {
  ...
  var BalloonTimePicker = TimePicker.extend({
    ...
    init: function(target, options) {
      ...
      $kSelect.empty();
      $kSelect.append('<svg class="gr-icon gr-i-clock" viewBox="0 0 24 24"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="../node_modules/@gyselroth/icon-collection/src/icons.svg#clock"></use></svg>');
    },
